document.addEventListener("DOMContentLoaded", function () {
    ...
    function r(e) {
        ...
        const t = this.getAttribute("href").split("#"),
            s =
                document.getElementById(t[1]).getBoundingClientRect().top +
                document.documentElement.scrollTop -
                20;
        scroll({ top: s, behavior: "smooth" });
    }
    ...
    a.forEach((e) => {
        ...
        v.forEach((e) => {
            e.addEventListener("click", function () {
                this.closest(".links__submenu").classList.remove("open"),
    ...
    p &&
        ...
        $(".js-button-expander").click(function (e) {
            for (
                var t = $(this).parent(),
                    s = $(t).children(".js-expand-content"),
                    n = 0;
                n < expanderList.length;
                n++
            )
                if (expanderList[n] == this)
                    for (var o = 0; o < s.length; o++)
                        $(s[o]).hasClass("expanded")
                            ? ($(t).removeClass("active"),
                              $(s[o]).removeClass("expanded"),
                              $(s[o]).slideUp())
                            : ($(t).addClass("active"),
                              $(s[o]).addClass("expanded"),
                              $(s[o]).slideDown());
                else {
        ...
        $(".screens-slider").length &&
            $(".screens-slider").slick({
                ...
                speed: 800,
                responsive: [
                    { breakpoint: 799, settings: { slidesToShow: 2 } },
