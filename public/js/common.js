document.addEventListener("DOMContentLoaded", function () {
    ...
    function clickHandler(e) {
        ...
        const offsetTop =
            document.getElementById(href[1]).getBoundingClientRect().top +
    ...
    $(".js-button-expander").click(function (e) {
        ...
        for (var i = 0; i < expanderList.length; i++) {
            if (expanderList[i] == this) {
                ...
                var expanderListTarget =
                    $(expanderListParent).children(".js-expand-content");
                if (
                    $(expanderListTarget).hasClass("expanded") &&
                    $(expanderListParent).hasClass("active")
                ) {
