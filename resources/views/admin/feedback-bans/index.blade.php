                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    Action
                                    <span class="help-tooltip-icon" title="abort - throw '429 Too Many Requests' error when user tries to submit feedback. spam - allow submit feedback, but mark feedback as spam automatically">
